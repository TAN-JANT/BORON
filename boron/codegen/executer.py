from .section import Relocation,Section,Symbol,SectionFlags
...
class Executer:
    ...
    def execute(self):
        ...
        binary  = bytearray()
        main_offset = 0 # it will be assigned when executer allocates the memory
        ...
        # 6: Apply relocations
        # TODO: 'symbols' sözlüğünü ve 'base_addr + offset' değerlerini kullanarak 
        # mutlak (absolute) ve bağıl (relative) adresleri patch'leyin.
